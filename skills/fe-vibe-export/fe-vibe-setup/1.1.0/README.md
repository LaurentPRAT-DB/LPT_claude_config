...
- Verify ralph-wiggum and agent-sdk-dev are present
...
**Option 1: Re-run install script** (updates everything)
```bash
gh release download latest --repo databricks-field-eng/vibe --pattern 'install_vibe.sh' -O - | zsh
```
