...
**IMPORTANT: Before running profile discovery, validate MCP access.**

First, check if Glean and Slack MCP connections are active:
...
```bash
# Get user ID from above, then check Slack
...
If either shows "Credential not found", provide login URLs:
- **Slack**: https://adb-2548836972759138.18.azuredatabricks.net/explore/connections/slack-mcp?o=2548836972759138
- **Glean**: https://adb-2548836972759138.18.azuredatabricks.net/explore/connections/glean-mcp?o=2548836972759138
...
- **Name**: Capitalize and format from username (e.g., "Brandon Kvarda")
