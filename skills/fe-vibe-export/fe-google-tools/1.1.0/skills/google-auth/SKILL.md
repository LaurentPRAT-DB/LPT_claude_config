---
name: google-auth
description: Unified authentication for all Google Workspace APIs (Docs, Sheets, Slides, Drive, Calendar, Gmail)
---

# Google Authentication Skill

Unified authentication for all Google Workspace APIs. This skill is the single source of truth for Google authentication - all other Google skills (gmail, google-calendar, google-docs, google-sheets-creator, google-slides-creator) use this for auth.
...
1. Check you have access to the quota project: `gcp-sandbox-field-eng`
2. Verify token is valid: `python3 google_auth.py validate`
...
- `/google-sheets-creator` - Spreadsheet operations
- `/google-slides-creator` - Presentation creation
