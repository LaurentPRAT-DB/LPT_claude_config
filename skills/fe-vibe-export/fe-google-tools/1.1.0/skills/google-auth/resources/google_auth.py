...
def do_login(force: bool = False) -> bool:
    ...
    scopes = ",".join(REQUIRED_SCOPES)
    print(f"Authenticating with scopes for Google Workspace...")
    ...
    print("You now have access to: Docs, Sheets, Slides, Drive, Calendar, Gmail")
    return True
...
"""
    ...
    if not args.command or args.command == "status":
        ...
        success = do_login(force=args.force)
