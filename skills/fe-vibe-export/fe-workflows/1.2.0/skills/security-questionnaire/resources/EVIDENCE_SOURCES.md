...
## Internal Resources (Require Databricks Login)

### go/ Links

| Resource | go/ Link | Description |
|----------|----------|-------------|
| SQRC Database | go/sqrc | Pre-answered questions (500+) |
| Submit Form | go/sqrc/submitform | Submit for security review |
| Trust FAQ | go/trustfaq | Security and compliance FAQ |
| Enterprise Security Guide | go/esg | Cloud-specific security guides |
| Shared Responsibility | go/srm | Shared responsibility model |

### Confluence Spaces

| Resource | Location |
|----------|----------|
| Security Policies | Confluence: Security ISMS |
| Penetration Testing | Confluence: Security Testing |
| Incident Response | Confluence: SIRT |
| Compliance | Confluence: Trust & Compliance |

### Google Drive Folders

| Resource | Location |
|----------|----------|
| Approved Security Policies | Google Drive: Security Policies |
| SOC 2 Report | Google Drive: Compliance Reports |
| ISO Certificates | Google Drive: Certifications |
| Penetration Test Summary | Google Drive: Security Assessments |
...
| Channel | Purpose |
|---------|---------|
| #security | General security questions, time-sensitive requests |
| #security-trust | Trust team questions, compliance attestations |
| #privacy | Privacy-specific questions, GDPR/CCPA |
| #sqrc-help | SQRC process questions |
| #legal | Contractual security terms |
